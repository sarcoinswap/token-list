...
const blacklist: string[] = [
  ...
  "0xCa127b33F6e606660D8AbA486A4b167fEd4b5612", // SRS
...
/**
 * Fetch Top100 Tokens traded on SarcoinSwap v2, ordered by trading volume,
...
const getTokenLogo = (address: string): string => {
  ...
  if (logoFiles.includes(`${address}.png`)) {
    return `https://tokens.sarcoinswap.finance/images/${address}.png`;
  }
...
const main = async (): Promise<void> => {
  try {
    ...
    const tokenListPath = `${path.resolve()}/src/tokens/sarcoinswap-top-100.json`;
